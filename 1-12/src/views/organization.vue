    ...
    <el-card>
      ...
      >
        ...
        <el-table-column prop="username" label="操作">
          ...
          <el-button type="danger" size="small" @click="del(index)"
            >删除</el-button
          >
        </el-table-column>
      </el-table>
...
export default {
  ...
  data() {
    return {
      list: [
        {
          id: "604e2aeb488be61b90b68776",
          name: "系统管理员",
          description: "管理整合平台，可以操作企业所有功能"
        },
        {
          id: "604e2b03488be61b90b68777",
          name: "人事经理",
          description: "负责整合人事部门"
        },
        {
          id: "604e2b12488be61b90b68779",
          name: "人事专员",
          description: "只能操作员工菜单"
        },
        {
          id: "604e2b19488be61b90b6877a",
          name: "薪资专员",
          description: "绩效管理"
        },
        { id: "604e2b25488be61b90b6877b", name: "员工", description: "员工" },
        {
          id: "63beaa9e81b4da1595e82e23",
          name: "211221",
          description: "22121"
        },
